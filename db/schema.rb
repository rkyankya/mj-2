...
ActiveRecord::Schema.define(version: 20_200_524_103_032) do
  ...
  create_table 'spree_order_commissions', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[order_id vendor_id], name: 'index_spree_order_commissions_on_order_id_and_vendor_id', unique: true
  ...
  create_table 'spree_vendor_users', force: :cascade do |t|
    ...
    t.index %w[vendor_id user_id], name: 'index_spree_vendor_users_on_vendor_id_and_user_id', unique: true
